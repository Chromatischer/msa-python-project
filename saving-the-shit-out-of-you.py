...
class DataHandler:
    ...
    def create_item_debug():
        value = Position(MovementAgent.get_mot_pos(1, True), MovementAgent.get_mot_pos(2, True), MovementAgent.get_mot_pos(3, True),
...
if __name__ == "__main__":
    print(DataHandler.get_pos_as_str(1))
    DataHandler.create_item_debug()
    print(DataHandler.get_pos_as_str(1))
